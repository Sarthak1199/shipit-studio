...
export const metadata: Metadata = { title: "Case studies", description: "Five builds, real numbers. Internal tools, automation and AI agents shipped for real businesses." };
      ...
      <section className="pt-24 sm:pt-28">
        <div className="container-x">
          <div className="flex items-end justify-between gap-4">
            ...
            <p className="pb-1 font-mono text-[11px] uppercase tracking-[0.18em] text-muted">{caseStudies.length} builds</p>
          </div>
