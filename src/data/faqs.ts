...
export const faqs: Faq[] = [
  { q: "What does it cost?", a: "Fixed price per build, quoted after the scope call. No hourly billing, no retainer you forget to cancel. If the scope changes, we requote before we build. Starting prices: AI agents & automations from ₹70,000 (~$840) · Internal platforms & webapps from ₹2,00,000 (~$2,400) · Enterprise AI systems from ₹7,00,000 (~$8,400)." },
